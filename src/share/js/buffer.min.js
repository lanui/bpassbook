this.Buffer = (function (t) {
  ...
  function (t, r, e) {
    (function (t, n) {
      ...
      function h(t, r, e, n) {
        return (
          s(r),
          0 >= r ? u(t, r) : void 0 !== e ? ('string' == typeof n ? u(t, r).fill(e, n) : u(t, r).fill(e)) : u(t, r)
        );
      }
      function a(r, e) {
        if ((s(e), (r = u(r, 0 > e ? 0 : 0 | y(e))), !t.TYPED_ARRAY_SUPPORT)) for (var n = 0; e > n; n++) r[n] = 0;
        return r;
      }
      function c(r, e, n) {
          ...
          if (e >= i + f) {
            ...
            switch (f) {
              case 1:
                ...
                break;
              case 2:
                (s = t[i + 1]), 128 === (192 & s) && ((c = ((31 & o) << 6) | (63 & s)), c > 127 && (u = c));
                break;
              case 3:
                (s = t[i + 1]),
                  (h = t[i + 2]),
      ...
      function D(t, r, e, n) {
        ...
        for (var i = 0, o = Math.min(t.length - e, 4); o > i; i++) t[e + i] = (r >>> (8 * (n ? i : 3 - i))) & 255;
      }
      ...
      function N(t, r, e, n, i) {
        return i || k(t, r, e, 4, 3.4028234663852886e38, -3.4028234663852886e38), Q.write(t, r, e, n, 23, 4), e + 4;
      }
      function F(t, r, e, n, i) {
        return i || k(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308), Q.write(t, r, e, n, 52, 8), e + 8;
      }
      function j(t) {
      ...
      (r.Buffer = t),
        ...
        (t.prototype.inspect = function () {
          ...
          return (
            this.length > 0 &&
              ((t = this.toString('hex', 0, e).match(/.{2}/g).join(' ')), this.length > e && (t += ' ... ')),
            '<Buffer ' + t + '>'
          );
        }),
        (t.prototype.compare = function (r, e, n, i, o) {
          ...
          for (var u = o - i, f = n - e, s = Math.min(u, f), h = this.slice(i, o), a = r.slice(e, n), c = 0; s > c; ++c)
            if (h[c] !== a[c]) {
              (u = h[c]), (f = a[c]);
              break;
            }
        ...
        (t.prototype.indexOf = function (r, e, n) {
          ...
          if ((0 > e && (e = Math.max(this.length + e, 0)), 'string' == typeof r && (r = t.from(r, n)), t.isBuffer(r)))
        ...
        (t.prototype.write = function (t, r, e, n) {
          ...
          var i = this.length - r;
          if (((void 0 === e || e > i) && (e = i), (t.length > 0 && (0 > e || 0 > r)) || r > this.length))
      ...
      (t.prototype.slice = function (r, e) {
        ...
        (t.prototype.readUInt32LE = function (t, r) {
          return (
            r || L(t, 4, this.length), (this[t] | (this[t + 1] << 8) | (this[t + 2] << 16)) + 16777216 * this[t + 3]
          );
        }),
        (t.prototype.readUInt32BE = function (t, r) {
          return (
            r || L(t, 4, this.length), 16777216 * this[t] + ((this[t + 1] << 16) | (this[t + 2] << 8) | this[t + 3])
          );
        }),
        ...
        (t.prototype.writeUInt16LE = function (r, e, n) {
          return (
            ...
            t.TYPED_ARRAY_SUPPORT ? ((this[e] = 255 & r), (this[e + 1] = r >>> 8)) : x(this, r, e, !0),
            e + 2
          );
        }),
        (t.prototype.writeUInt16BE = function (r, e, n) {
          return (
            ...
            (e = 0 | e),
            n || O(this, r, e, 2, 65535, 0),
            t.TYPED_ARRAY_SUPPORT ? ((this[e] = r >>> 8), (this[e + 1] = 255 & r)) : x(this, r, e, !1),
            e + 2
          );
        }),
        (t.prototype.writeUInt32LE = function (r, e, n) {
          return (
            ...
            t.TYPED_ARRAY_SUPPORT
              ? ((this[e + 3] = r >>> 24), (this[e + 2] = r >>> 16), (this[e + 1] = r >>> 8), (this[e] = 255 & r))
              : D(this, r, e, !0),
            e + 4
          );
        }),
        (t.prototype.writeUInt32BE = function (r, e, n) {
          return (
            ...
            n || O(this, r, e, 4, 4294967295, 0),
            t.TYPED_ARRAY_SUPPORT
              ? ((this[e] = r >>> 24), (this[e + 1] = r >>> 16), (this[e + 2] = r >>> 8), (this[e + 3] = 255 & r))
              : D(this, r, e, !1),
            e + 4
          );
        }),
        (t.prototype.writeIntLE = function (t, r, e, n) {
          ...
          for (this[r] = 255 & t; ++o < e && (u *= 256); )
            0 > t && 0 === f && 0 !== this[r + o - 1] && (f = 1), (this[r + o] = (((t / u) >> 0) - f) & 255);
          return r + e;
        }),
        ...
        (t.prototype.writeInt32LE = function (r, e, n) {
          return (
            ...
            t.TYPED_ARRAY_SUPPORT
              ? ((this[e] = 255 & r), (this[e + 1] = r >>> 8), (this[e + 2] = r >>> 16), (this[e + 3] = r >>> 24))
              : D(this, r, e, !0),
            e + 4
          );
        }),
        ...
        (t.prototype.copy = function (r, e, n, i) {
          ...
          else if (1e3 > u || !t.TYPED_ARRAY_SUPPORT) for (o = 0; u > o; o++) r[o + e] = this[o + n];
  ...
  function (t, r) {
    ...
    function n(t) {
      ...
      (o = '=' === t[f - 2] ? 2 : '=' === t[f - 1] ? 1 : 0), (u = new h((3 * f) / 4 - o)), (n = o > 0 ? f - 4 : f);
      var a = 0;
      ...
      return (
        2 === o
          ...
          : 1 === o &&
            ((i = (s[t.charCodeAt(r)] << 10) | (s[t.charCodeAt(r + 1)] << 4) | (s[t.charCodeAt(r + 2)] >> 2)),
            (u[a++] = (i >> 8) & 255),
            (u[a++] = 255 & i)),
        u
      );
    ...
    function o(t, r, e) {
      for (var n, o = [], u = r; e > u; u += 3) (n = (t[u] << 16) + (t[u + 1] << 8) + t[u + 2]), o.push(i(n));
      return o.join('');
    }
    function u(t) {
      for (var r, e = t.length, n = e % 3, i = '', u = [], s = 16383, h = 0, a = e - n; a > h; h += s)
  ...
  function (t, r) {
    (r.read = function (t, r, e, n, i) {
      var o,
        ...
        l = e ? -1 : 1,
        p = t[r + c];
      for (c += l, o = p & ((1 << -a) - 1), p >>= -a, a += f; a > 0; o = 256 * o + t[r + c], c += l, a -= 8);
      for (u = o & ((1 << -a) - 1), o >>= -a, a += n; a > 0; u = 256 * u + t[r + c], c += l, a -= 8);
      if (0 === o) o = 1 - h;
      else {
