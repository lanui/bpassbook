!(function (t) {
      ...
      fromBytes: function (t) {
        for (var e = [], r = 0; r < t.length; ) {
          ...
          i < 128
            ...
            : (e.push(String.fromCharCode(((15 & i) << 12) | ((63 & t[r + 1]) << 6) | (63 & t[r + 2]))), (r += 3));
        }
        return e.join('');
      },
    },
  ...
  (A.prototype._prepare = function () {
    ...
    var r,
      ...
      n = this.key.length / 4,
      s = S(this.key);
    for (e = 0; e < n; e++) (r = e >> 2), (this._Ke[r][e % 4] = s[e]), (this._Kd[t - r][e % 4] = s[e]);
    for (var o, h = 0, a = n; a < i; ) {
      if (
        ...
        (o = s[n / 2 - 1]),
          (s[n / 2] ^= p[255 & o] ^ (p[(o >> 8) & 255] << 8) ^ (p[(o >> 16) & 255] << 16) ^ (p[(o >> 24) & 255] << 24));
    ...
    for (var f = 1; f < t; f++)
      for (var u = 0; u < 4; u++)
        (o = this._Kd[f][u]),
          (this._Kd[f][u] = b[(o >> 24) & 255] ^ E[(o >> 16) & 255] ^ C[(o >> 8) & 255] ^ z[255 & o]);
  }),
    (A.prototype.encrypt = function (t) {
      if (16 != t.length) throw new Error('invalid plaintext size (must be 16 bytes)');
      for (var e = this._Ke.length - 1, r = [0, 0, 0, 0], i = S(t), n = 0; n < 4; n++) i[n] ^= this._Ke[0][n];
      for (var s = 1; s < e; s++) {
        for (n = 0; n < 4; n++)
          r[n] =
            u[(i[n] >> 24) & 255] ^
    ...
    (A.prototype.decrypt = function (t) {
      ...
      for (var e = this._Kd.length - 1, r = [0, 0, 0, 0], i = S(t), n = 0; n < 4; n++) i[n] ^= this._Kd[0][n];
      for (var s = 1; s < e; s++) {
        for (n = 0; n < 4; n++)
          r[n] =
            _[(i[n] >> 24) & 255] ^
  ...
  (K.prototype.encrypt = function (t) {
    if ((t = s(t)).length % 16 != 0) throw new Error('invalid plaintext size (must be multiple of 16 bytes)');
    for (var e = a(t.length), r = a(16), i = 0; i < t.length; i += 16)
      o(t, r, 0, i, i + 16), o((r = this._aes.encrypt(r)), e, i);
    return e;
  }),
    (K.prototype.decrypt = function (t) {
      if ((t = s(t)).length % 16 != 0) throw new Error('invalid ciphertext size (must be multiple of 16 bytes)');
      for (var e = a(t.length), r = a(16), i = 0; i < t.length; i += 16)
  ...
  (P.prototype.setValue = function (t) {
    ...
    (P.prototype.setBytes = function (t) {
      if (16 != (t = s(t, !0)).length) throw new Error('invalid counter bytes size (must be 16 bytes)');
      this._counter = t;
    }),
